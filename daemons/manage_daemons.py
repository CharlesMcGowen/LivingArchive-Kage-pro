...
=======================
Start, stop, and check status of Kage, Kumo, and Ryu daemons.
"""
...
DAEMONS = {
    ...
    'ryu': {
        'script': DAEMON_DIR / 'ryu_daemon.py',
        'pid_file': PID_DIR / 'ryu_daemon.pid',
        'name': 'Ryu'
    },
    'suzu': {
        'script': DAEMON_DIR / 'suzu_daemon.py',
        'pid_file': PID_DIR / 'suzu_daemon.pid',
        'name': 'Suzu'
    }
}
